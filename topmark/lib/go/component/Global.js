enyo.kind({
	...
	statics: {
		...
		resetLocal:function(key){
			enyo.log("Resetting LocalStorage for key: " +key);
			delete localStorage[key];
		},
		flush:function(){
			enyo.log("WARNING: Flushing all localStorage");
			localStorage.clear();
		},
		setObject:function(key, value){
			this.globalObject[key] = value;
			enyo.log("=== Stored Object ===");
			enyo.log(this.globalObject);
		},
		getObject:function(key){
			enyo.log("== Fetching ["+key+"] ===");
		...
		logger: {
			...
			writers: [
				function(msg) {
					enyo.log(msg.level + ": " + msg.date + ", ", msg.msg);
				}
			],
		...
		combineJsonObjects: function(jsonArray) {
        var result = {};
