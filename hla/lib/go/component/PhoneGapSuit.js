...
enyo.kind({
	...
	statics: {
		...
		notify: function(message) {
			go.Notification.notify(message);
		},
		// alias for dialogPrompt
		confirm: function() {
			this.dialogPrompt.apply(this, arguments);
		},
		...
		dialogPromptSwitch : function(message, onConfirmCallBack, title, mode){
			if (mode == "PG"){
				...
				var returnValue = go.Confirm.confirm(message, onConfirmCallBack);
			}
		},
