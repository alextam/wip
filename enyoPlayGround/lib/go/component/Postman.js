enyo.kind({
	...
	****************************************************************/
	...
	ajax: function(options) {
		...
		var ajax = new enyo.Ajax(options);
		ajax.go();
		ajax.response(this, function(_this, response) {
			dfd.resolve(ajax, response);
		});
		ajax.error(this, function(_this, statusCode) {
			dfd.reject(ajax, statusCode);
		});
