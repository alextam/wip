...
enyo.kind({
    ...
    imageLoaded: function(inSender,inEvent){
        ...
        } else if (inEvent.type == "error") {
            this.$.spinnerView.hide();
            if (this.fallBackImg != ""){
                this.applyStyle("background", "url("+ this.fallBackImg +") no-repeat; background-position:" +this.bgPosition);
            }   
        }
    },
